...
##Changes 090925 CFR
filtered_data_labor$governorate <- as.factor(filtered_data_labor$governorate)
filtered_data_labor$wealth_quintile <- as.factor(filtered_data_labor$wealth_quintile)
filtered_data_labor$educ_level1 <- factor(filtered_data_labor$educ_level1,
                       levels = 1:7,
                       labels = c("Illiterate", "Read & Write", "Basic Education",
                                  "Secondary", "Post-Secondary", "University", "Post-Graduate"))
